...
(() => {
  ...
  const MESSAGES = {
    zh: {
      ...
      'edu.t1': '教育',
      'edu.t2': '经历',
      'edu1.degree': '本科 · XX 专业',
      'edu1.school': 'XX 大学 — 荣誉奖项（如有）',
      'edu1.date': '2022.09 - 2026.06',
      'edu1.score': 'GPA 3.7',
      'edu2.degree': '高中',
      'edu2.school': 'XX 中学 — 荣誉奖项（如有）',
      'edu2.date': '2019.09 - 2022.06',
      'edu2.score': '98.5',
      'projects.t1': '精选',
      'projects.t2': '项目',
      'p1.name': '个人作品集网站',
    ...
    en: {
      ...
      'edu.t1': 'My',
      'edu.t2': 'Education',
      'edu1.degree': 'B.Sc. · Your Major',
      'edu1.school': 'XX University — Honors (if any)',
      'edu1.date': 'Sep 2022 - Jun 2026',
      'edu1.score': 'GPA 3.7',
      'edu2.degree': 'High School',
      'edu2.school': 'XX High School — Honors (if any)',
      'edu2.date': 'Sep 2019 - Jun 2022',
      'edu2.score': '98.5',
